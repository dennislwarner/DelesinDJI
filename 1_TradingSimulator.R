...
l.ScriptFilesUsed[[1]]<-paste(dirProject, "/0_AllFunctions.R", sep = "");
l.ScriptFilesUsed[[2]]<-paste(dirProject, "/0_BuildDJI.R", sep = "")
l.ScriptFilesUsed[[3]]<-paste(dirProject, "/0_f.TradeSim.R",sep="")
l.ScriptFilesUsed[[4]]<-paste(dirProject, "/0_SimTradingFunctions.R",sep="")
l.ScriptFilesUsed[[5]]<-paste(dirProject,"/0_Prep.R",sep="");
